  ...
  if (sections.colaboradores) {
    ...
    const buildCards = list => {
      ...
      return list.map(c => {
        ...
        const sepRow = `<tr><td colspan="99" style="padding:8px 0;background:#f8fafc;border-top:2px solid #e2e8f0;border-bottom:1px solid #e2e8f0"></td></tr>`;
        return `<div class="vcard"><div class="vcard-hdr"><strong>${fname}</strong></div><div style="padding-top:12px"><table>${colabThead()}<tbody>${pres}${sepRow}${atend}</tbody></table></div></div>`;
      }).join("");
    };
